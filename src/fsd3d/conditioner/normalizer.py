"""§3 — Context Normalization: The Data Bridge.

Merges visual tokens (from §1 Pilot Space / DomainAdapter) and conditioning
...
class ContextNormalizer(nn.Module):
    ...
    Merges outputs from §1 (visual tokens via DomainAdapter) and §2
    ...
    def forward(
        ...
        Args:
            visual_tokens:      (B, V, d_model) from §1 DomainAdapter.
